...
export const zh_CN: Translation = {
	...
	[Key.aiRadar]: "AI 雷达",
	[Key.aiRadarSubtitle]: "实时汇总 AI 服务状态、社区热点与模型趋势",
	[Key.aiRadarStatus]: "服务状态",
	[Key.aiRadarStories]: "社区热点",
	[Key.aiRadarModels]: "趋势模型",
	[Key.aiRadarRepos]: "活跃项目",
	[Key.aiRadarRefresh]: "立即刷新",
