...
export const ja: Translation = {
	...
	[Key.aiRadar]: "AI レーダー",
	[Key.aiRadarSubtitle]: "AI サービス状況・コミュニティ話題・モデル動向をリアルタイム集約",
	[Key.aiRadarStatus]: "サービス状況",
	[Key.aiRadarStories]: "コミュニティ話題",
	[Key.aiRadarModels]: "トレンドモデル",
	[Key.aiRadarRepos]: "アクティブなリポジトリ",
	[Key.aiRadarRefresh]: "今すぐ更新",
	[Key.aiRadarUpdated]: "更新",
	[Key.aiRadarLoading]: "読み込み中…",
	[Key.aiRadarUnavailable]: "利用不可",
	[Key.aiRadarCodex]: "モデル知能効率ランキング",
};
